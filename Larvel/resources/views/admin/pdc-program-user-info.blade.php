    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            @foreach ($userProfile as $profile)
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-center d-block rounded p-3 bg-info" style="font-weight: bold"><i
                                class="pr-2 fa fa-"></i>د اړونده {{ $name }} په اړه بشپړ معلومات</h4>
                    </div>
                    <div class="col-md-8">
                        <div class="job-info job-widget" style=" box-shadow:0px 0px 0px 1px #00beff; border-radius: 5px; ">
                            ...
                            <ul class="job-post-det col-md-12">
                                ...
                                @endif
                                <li class="col-md-12"><i class="pr-2 fa fa-university"></i>د {{ $name }} کاري
                                    ځاي: <span class="text-blue">{{ $profile->office_campus }}</span></li>
                                <li class="col-md-12"><i class="pr-2 fa fa-building"></i>د {{ $name }} کاري
                                    بلاک: <span class="text-blue">{{ $profile->office_building }}</span></li>
                                <li class="col-md-12"><i class="pr-2 fa fa-graduation-cap"></i>د {{ $name }}
                                    کاري شعبه: <span class="text-blue">{{ $profile->office_department }}</span></li>
                                <li class="col-md-12"><i class="pr-2 fa fa-pencil-square-o"></i>د {{ $name }}
                                    کاري رتبه: <span class="text-blue">{{ $profile->office_position }}</span></li>
                                <li class="col-md-12"><i class="pr-2 fa fa-pencil"></i>د {{ $name }} علمي
                                    رتبه: <span class="text-blue">{{ $profile->educational_rank }}</span></li>
