    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            @if (count($members) !== 0)
                ...
                <!-- Search Filter -->
                <form action="/admin/searchParticipant" method="POST">
                    {{ method_field('POST') }}
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3" onclick="audio.play()">
                            <div class="profile-widget" style="box-shadow: 0px 0px 2px 1px #89d0e5;">
                                <div class="profile-img">
                                    <a href="/admin/participantProfile/{{ $member->user_id }}" class="avatar"><i
                                ...
                                <div class="dropdown profile-action" dir="rtl">
                                    ...
                                    <div class="sel dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item"
                                            href="/admin/participantAllList/{{ $member->user_id }}/edit"><i
                                                class="fa fa-pencil m-r-5"></i> اصلاح یې کړی</a>
                                        <a class="dropdown-item" href="/admin/participantAllList/{{ $member->user_id }}"
                                ...
                                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a
                                        href="admin/participantProfile/{{ $member->id }}">{{ $member->educational_rank }}
