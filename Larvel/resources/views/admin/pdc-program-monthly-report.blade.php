    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title"> میاښتنی راپورونه</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>د روزنیز برنامی دول</th>
                                    <th>د برنامې عنوان</th>
                                    <th> په لاره اچونکی</th>
                                    <th> برخه وال</th>
                                    <th>نیته </th>
                                    <th>وخت</th>
                                    <th> موده </th>
                                    <th> برخه والو شمیر</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <strong>ورکشاپ</strong>
                                    </td>
                                    <td>د پیزندگلوی ورکشاپ</td>
                                    <td>د لورو زده کرو وزارت</td>
                                    <td>کندهار کابل</td>
                                    <td> 1400/3/29-30</td>
                                    <td> 8:00-10:00</td>
                                    <td> دوی ورجی</td>
