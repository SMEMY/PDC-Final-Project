					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header p-lg-5">
								<h4 class="card-title mb-0">د اوړنده پروکرام په اړه د پایلو پاڼه</h4>
							</div>
							<div class="card-body">
								<form action="/admin/pdcProgramResult" method="POST" >
								{{ method_field('POST') }}
                            	{{ csrf_field() }}
								<input class="d-none" type="text" value="{{$programID}}" name='program_id'>
                                    ...
                                    <div class="row" id="files">
                                        <div class="input-group col-12">
                                            ...
                                            <textarea class="form-control" aria-label="With textarea" name="program_result[0]"></textarea>
                                        </div>
                                    </div>
	...
	<script>
		...
		function addFile() {
			...
			<div class="input-group mt-5 col-md-12">
				...
				<textarea class="form-control" aria-label="With textarea" name="program_result[${index}]"></textarea>
			</div>`;
