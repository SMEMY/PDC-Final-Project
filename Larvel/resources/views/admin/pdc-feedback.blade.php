...
<body class="account-page">
    ...
    <div class="main-wrapper">
        <a href="/admin/pdcProgramInfo/{{ $program_id }}" class="btn btn-primary apply-btn"><i class="fa fa-arrow-left"
        ...
        <div class="account-content">
            ...
            <div class=" ">
                ...
                <div class="account-box border board-danger" style="width: 1200px;">
                    @if (count($comments) !== 0 || count($locations) !== 0 || count($facilities) !== 0 || count($materials) !== 0)
                        <div class="dropdown dropdown-action profile-action" id="edit1">
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                ...
                                <a class="dropdown-item" data-toggle="modal" data-target="#delete_project" id="path"><i
                                        class="fa fa-trash-o m-r-5"></i> له منځه یې اوسی</a>
                            </div>
                        </div>
                    @endif
                                                ...
                                                <div class="dropdown dropdown-action profile-action" id="edit">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        <a class="dropdown-item"
                                                            href="/admin/deleteQuestion/{{ $material->id }}"><i
                                                                class="fa fa-trash-o m-r-5"></i>یاده پوښتنه له سیسټم څخه
                                                            له منځه یوسی</a>
                                                    </div>
                                                </div>
                                                <p class="mb-0 p-2 "
                                                    style="background:#d7e5ff6e;border-radius:5px;">(
                                                    {{ $loop->iteration }} ) <i class="fa fa-hand-o-left"></i>
                                                    {{ $material->question }}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="dropdown dropdown-action profile-action" id="edit">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        <a class="dropdown-item"
                                                            href="/deleteQuestion/{{ $facility->id }}"><i
                                                                class="fa fa-trash-o m-r-5"></i>یاده پوښتنه له سیسټم څخه
                                                            له منځه یوسی</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="">
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="dropdown dropdown-action profile-action" id="edit">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        <a class="dropdown-item"
                                                            href="/deleteQuestion/{{ $location->id }}"><i
                                                                class="fa fa-trash-o m-r-5"></i>یاده پوښتنه له سیسټم څخه
                                                            له منځه یوسی</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="">
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="dropdown dropdown-action profile-action" id="edit">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        <a class="dropdown-item"
                                                            href="/admin/deleteQuestion/{{ $comment->id }}"><i
                                                                class="fa fa-trash-o m-r-5"></i>یاده پوښتنه له سیسټم څخه
                                                            له منځه یوسی</a>
                                                    </div>
                                                </div>
