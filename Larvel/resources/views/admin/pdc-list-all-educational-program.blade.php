            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="/admin/addEduProgram" class="btn add-btn px-4"><i class="fa fa-plus"></i>پروګرام ثبت
                            کړی</a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body p-1">
                                    ...
                                    <a href="/admin/educationalPrograminfo/{{ $program->id }}">
                                        <div class="job-list-desc" style="padding: 15px 15px 5px 15px">
                                            ...
                                            <!-- <br> -->
                                            <h4 class="job-department "><strong>دشخص نوم: </strong>
                                                {{ $program->teacher_name }} {{ $program->teacher_last_name }}</h4>
                                            <h4 class="job-department "><strong>د پروګرام ډول: </strong>
                                                {{ $program->type }} </h4>
                                        ...
                                        <div class="job-list-footer p-0" id="foot">
                                            <ul class="m-0"
                                                ...
                                                <li class="ml-1 d-inline-block" dir="rtl"><i
                                                        class="fa fa-calendar text-danger"></i> <strong> نېټه:
