			...
			<div class="container ">
				...
				<div class="account-box" style="width: 1100px; margin-top: 75px; margin-right:140px;" id="for">
					<div class="account-wrapper mt-3" style="">
						<h3 class="account-title mb-5" style="font-size:35px !important; font-weight: bolder;">د مسلکي پرمختیائي مرکز پروګرام د ګډونوال معلومات ایدیټ کړی</h3>
						<!-- <p class="account-subtitle"></p> -->
<hr !important>
						<!-- Account Form -->
						<form action="/participantList/{{$participant->id}}" method="POST">
								{{ method_field('PUT') }}
      					 	    {{ csrf_field() }}
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input class="form-control " type="text" name="last_name" value="{{$participant->last_name}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<input class="form-control" type="tel" pattern="[0-9]+" name="phone_number" value="{{$participant->phone_number}}">
										</div>
									</div>
									<div class=" col-md-6">
										<div class="form-group">
											<label class="col-form-label">برېښنالیک<span
													class="text-danger">*</span></label>
											<input class="form-control" type="email" name="email" value="{{$participant->email}}">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">کاري ساحې نوم<span
													class="text-danger">*</span></label>
											<input class="form-control " type="text" name="office_campus" value="{{$participant->office_campus}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">کاري دفتر<span
													class="text-danger">*</span></label>
													<input class="form-control " type="text" name="office_building" value="{{$participant->office_building}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">کاري شعبه</label>
											<input class="form-control" type="text" name="office_department" value="{{$participant->office_department}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="custom-select" name="office_position">
												<!-- <option selected="">جنسیت</option> -->
												<option ></option>
												@if($participant->office_position === 'رئیس')
												...
												@elseif($participant->office_position === 'مرستیال')
												<option value="رئیس">رئیس</option>
												<option selected value="مرستیال">مرستیال</option>
												<option value="ښوونکی">ښوونکی</option>
												<option value="اداري کارمند">اداري کارمند</option>
												@elseif($participant->office_position === 'ښوونکی')
												<option value="رئیس">رئیس</option>
												<option value="مرستیال">مرستیال</option>
									...
									<div class="col-md-12" id="rank">
										<div class="form-group">
											...
											<select class="custom-select rankS" name="office_position_category">
												<option ></option>
												@if($participant->office_position_category === 'اداري')
												...
												@elseif($participant->office_position_category === 'تدریسي')
									...
									@if($participant->educational_rank != null)
									<div class="col-md-12" id="temp1">
										<div class="form-group">
											...
											<select class="form-control" name="educational_rank">
												<option></option>
												@if($participant->educational_rank === 'پوهایالی')
												...
												@elseif($participant->educational_rank === 'پوهنیار')
												<option value="پوهایالی">پوهایالی</option>
												<option selected value="پوهنیار">پوهنیار</option>
												<option value="پوهنمل">پوهنمل</option>
												<option value="پوهاند">پوهاند</option>
												@elseif($participant->educational_rank === 'پوهنمل')
												<option value="پوهایالی">پوهایالی</option>
												<option value="پوهنیار">پوهنیار</option>
								...
								<hr !important>	<!-- this part has been hidden just for DB participant role -->
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">پاسورډ<span
													class="text-danger">*</span></label>
											<input class="form-control" type="password" name="password" value="{{$participant->password}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
