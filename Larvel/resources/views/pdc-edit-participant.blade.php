...
<hr !important>
						<!-- Account Form -->
						<form action="/admin/participantAllList/{{$member[0]->id}}" method="POST">
								{{ method_field('PUT') }}
      					 	    {{ csrf_field() }}
								    @if ($errors->any())
								   ...
								   <input class="d-none" type="number" name="program_id" id="" value="{{$member[0]->program_id}}">
								   @endif
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">نوم <span class="text-danger">*</span></label>
											<input class="form-control " type="text" name="member_name" value="{{$member[0]->name}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">تخلص</label>
											<input class="form-control " type="text" name="last_name" value="{{$member[0]->last_name}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<input class="form-control" type="tel" pattern="[0-9]+" name="phone_number" value="{{$member[0]->phone_number}}">
										</div>
									</div>
									<div class=" col-md-6">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">کاري ساحې نوم<span
													class="text-danger">*</span></label>
											<input class="form-control " type="text" name="office_campus" value="{{$member[0]->office_campus}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">کاري دفتر<span
													class="text-danger">*</span></label>
													<input class="form-control " type="text" name="office_building" value="{{$member[0]->office_building}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-form-label">کاري شعبه</label>
											<input class="form-control" type="text" name="office_department" value="{{$member[0]->office_department}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="custom-select" name="office_position">
												<!-- <option selected="">جنسیت</option> -->
												<option ></option>
												@if($member[0]->office_position === 'رئیس')
												...
												@elseif($member[0]->office_position === 'مرستیال')
												<option value="رئیس">رئیس</option>
												<option selected value="مرستیال">مرستیال</option>
												<option value="ښوونکی">ښوونکی</option>
												<option value="اداري کارمند">اداري کارمند</option>
												@elseif($member[0]->office_position === 'ښوونکی')
												<option value="رئیس">رئیس</option>
												<option value="مرستیال">مرستیال</option>
									...
									<div class="col-md-12" id="rank">
										<div class="form-group">
											...
											<select class="custom-select rankS" name="office_position_category">
												<option ></option>
												@if($member[0]->office_position_category === 'اداري')
												...
												@elseif($member[0]->office_position_category === 'تدریسي')
									...
									<div class="col-md-12" id="temp1">
										<div class="form-group">
											...
											<select class="form-control" name="educational_rank">
												<option></option>
												@if($member[0]->educational_rank === 'پوهایالی')
