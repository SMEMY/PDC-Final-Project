					...
					<div class="row align-items-center">
						...
						<div class="col-auto float-right ml-auto">
							<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_client"><i
									class="fa fa-plus"></i> ګډون کوونکی اضافه کړی</a>
				...
				<div class="row filter-row">
					<div class="col-sm-6 col-md-4">
						<div class="form-group form-focus">
							...
							<label class="focus-label">د ګډون کوونکی نوم</label>
						</div>
					</div>
					<div class="col-sm-6 col-md-4">
						<div class="form-group form-focus">
							<input type="text" class="form-control floating">
							<label class="focus-label">د ګډون کوونکی د ټلیفون شمېره</label>
						</div>
					</div>
				...
				<div class="row staff-grid-row">
					<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
						<div class="profile-widget">
							...
							<div class="small text-muted">ګډون کوونکی</div>
				...
				<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">ګډون کوونکی اضافه کړی</h5>
					...
					<div class="modal-content">
						<div class="modal-body">
							<div class="form-header">
								<h3>ګډون کوونکی له منځه وړل</h3>
								<p>آیا تاسي باوري یاست چي ګډون کوونکی له سیسټم څخه له منځه یوسي؟</p>
							</div>
