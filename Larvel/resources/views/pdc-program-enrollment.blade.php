			...
			<div class="container ">
				...
				<div class="account-box " style="width: 800px;">
					<div class="account-wrapper" >
						<h2 class="account-title h1"><strong>(په پروګرام کي د ثبت کېدلو لپاره د یاد پروګرام ځانکړی کوډ داخل کړی)</strong></h2>
						...
						<form action="/memberEnrollmentForProgram" method="post">
							...
							<div class="form-group text-center col-md-4 m-auto">
								<button class="btn btn-primary  account-btn col-md-12 p-1" type="submit">پروګرام کي ثبت شی</button>
							</div>
