            ...
            <div class="container ">
                ...
                <div class="account-box " style="width: 1000px;">
                    <div class="account-wrapper" style="">
                        <h3 class="account-title p-3">د سیسټم د ګډونوال محافظوي پوښتنو پاڼه</h3>
                        <hr>
                        <!-- <p class="account-subtitle"></p> -->

                        <!-- Account Form -->
                        <form action="/user/questionsChange" method="POST">
                            @csrf
                            {{-- @if ($errors->any())
                                ...
                                <div class="col-sm-6 col-md-12" id="search_content">
                                    <div class="form-group form-focus select-focus mb-5">
                                        ...
                                        <select class="custom-select p-2 h-100 searchInput" name="f_q">
                                            ...
                                            @if (old('f_q') == '{{ $questions[0]->f_q }}')
                                                <option selected value="{{ $questions[0]->f_q }}">
                                                    {{ $questions[0]->f_q }}
                                                </option>
                                            ...
                                            @elseif (old('f_q') === '{{ $questions[0]->s_q }}')
                                                {{-- <option value="">پوښتنه مو انتخاب کړی!</option> --}}
                                                <option value="{{ $questions[0]->f_q }}">
                                                    {{ $questions[0]->f_q }}
                                                </option>
                                                <option selected value="{{ $questions[0]->s_q }}">
                                                    {{ $questions[0]->s_q }}
                                                </option>
                                                <option value="{{ $questions[0]->t_q }}">{{ $questions[0]->t_q }}
                                                </option>
                                            @elseif (old('f_q') === '{{ $questions[0]->t_q }}')
                                                {{-- <option value="">پوښتنه مو انتخاب کړی!</option> --}}
                                                <option value="{{ $questions[0]->f_q }}">
                                                    {{ $questions[0]->f_q }}
                                                </option>
                                                ...
                                                <option selected value="{{ $questions[0]->t_q }}">
                                                    {{ $questions[0]->t_q }}
                                                </option>
                                            @else
                                                {{-- <option value="">پوښتنه مو انتخاب کړی!</option> --}}
