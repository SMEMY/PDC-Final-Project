...
<body class="account-page">
    ...
    <div class="main-wrapper">
        <div class="account-content">
            <a href="/user/profile/{{ auth()->user()->id }}" class="btn btn-primary apply-btn">ادمېن معلومات</a>
            <div class="container pb-5 mb-5">
                ...
                <div class="account-box " style="width: 1000px;">
                    <div class="account-wrapper" style="">
                        <h3 class="account-title p-3">د اډمین د پاسورډ د تغیرولو پاڼه</h3>
                        <hr>
                        <!-- <p class="account-subtitle"></p> -->

                        <!-- Account Form -->
                        <form action="/user/passwordChange" method="POST" enctype="multipart/form-data">
                            {{-- {{ method_field('PATCH') }} --}}
                            {{ csrf_field() }}
                            ...
                            <dvi class="row p-3">
                                ...
                                <div class="form-group col-md-6 p-3">
                                    <label>د نوي پاسورډ تائیدي</label>
