								...
								<input class="d-none" type="text" value="{{$programID}}" name='program_id'>
                                    ...
                                    <div class="row" id="files">
                                        <div class="input-group col-12">
                                            ...
                                            <textarea class="form-control" aria-label="With textarea" name="program_evaluation[0]"></textarea>
                                        </div>
                                    </div>
	...
	<script>
		...
		function addFile() {
			...
			<div class="input-group mt-5 col-md-12">
				...
				<textarea class="form-control" aria-label="With textarea" name="program_evaluation[${index}]"></textarea>
			</div>`;
